...
namespace CSharpInterface.gui
{
    partial class main
    {
        ...
        private void InitializeComponent()
        {
            ...
            destinationTextBox.ForeColor = SystemColors.GrayText;
            destinationTextBox.Enter += TextBox_Enter;
            destinationTextBox.Leave += TextBox_Leave;
            ...
            addressTextBox.ForeColor = SystemColors.GrayText;
        ...
        private void TextBox_Leave(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(textBox.Text))
            {
                ...
                else if (textBox.Name == "destinationTextBox")
                {
